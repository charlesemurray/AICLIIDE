...
mod storage_tests {
    ...
    async fn test_code_reviewer_template_specifics() {
        ...
        assert_eq!(
            template.category,
            crate::cli::creation::prompt_system::types::TemplateCategory::CodeReviewer
        );
        assert_eq!(
            template.difficulty,
            crate::cli::creation::prompt_system::types::DifficultyLevel::Intermediate
        );
    ...
    async fn test_documentation_writer_template_specifics() {
        ...
        assert_eq!(
            template.category,
            crate::cli::creation::prompt_system::types::TemplateCategory::DocumentationWriter
        );
        assert_eq!(
            template.difficulty,
            crate::cli::creation::prompt_system::types::DifficultyLevel::Beginner
        );
    ...
    async fn test_conversation_assistant_template_specifics() {
        ...
        assert_eq!(
            template.category,
            crate::cli::creation::prompt_system::types::TemplateCategory::ConversationAssistant
        );
        assert_eq!(
            template.difficulty,
            crate::cli::creation::prompt_system::types::DifficultyLevel::Beginner
