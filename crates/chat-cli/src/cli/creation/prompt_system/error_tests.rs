...
mod error_tests {
    ...
    async fn test_template_error_types() {
        ...
        let error = TemplateError::RenderingFailed {
        ...
        let error = TemplateError::SecurityViolation {
            violation: "unsafe content".to_string(),
        };
        let error_string = error.to_string();
    ...
    async fn test_suggestion_algorithm_robustness() {
        ...
        for use_case in test_cases {
            ...
            assert!(
                suggestions.len() <= 3,
                "Too many suggestions for use case: '{}'",
                use_case
            );
    ...
    async fn test_template_structure_validation() {
        ...
        for template_info in templates {
            ...
            assert!(
                !full_template.capabilities.is_empty(),
                "Template capabilities are empty"
            );
