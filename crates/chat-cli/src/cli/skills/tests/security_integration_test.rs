...
mod security_integration_tests {
    ...
    fn test_complete_security_framework() {
        ...
        let signoff_decision = security_tools
            .signoff_manager
    ...
    fn test_security_design_principles() {
        ...
        // 2. Least Privilege
        assert!(matches!(
            untrusted_context.permissions.network_access,
            NetworkPermissions::None
        ));
        assert!(matches!(
            untrusted_context.permissions.file_access,
        ...
        assert!(matches!(
            user_context.permissions.network_access,
